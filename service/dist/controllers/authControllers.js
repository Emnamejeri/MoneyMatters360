...
var authController = {
    login: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, user, passwordMatch, token, error_1;
    ...
    register: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, fullName, email, username, address, dob, password, hashedPassword, newUser, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                    _a = req.body, fullName = _a.fullName, email = _a.email, username = _a.username, address = _a.address, dob = _a.dob, password = _a.password;
